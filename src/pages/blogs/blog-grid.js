                                    ...
                                    <div className="col-md-6 col-sm-12">								
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                ...
                                                <h3 className="blog-title"><Link to="/blog-details">What’s the Future of Nail Art?</Link></h3>
                                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                            </div>
                                        </div>
                                        {/* Blog Post */}                                     
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                <ul className="entry-meta meta-item">
                                                    <li>
                                                        <div className="post-author">
                                                            <Link to="/stylist-profile"><img src={StylistThumb5} alt="Post Author" /> <span>Aditi Menard</span></Link>
                                                        </div>
                                                    </li>
                                                    <li><FontAwesomeIcon icon={faClock} /> 1 Dec 2020</li>
                                                </ul>
                                                <h3 className="blog-title"><Link to="/blog-details">The Top-Selling Nail Polish colors</Link></h3>
                                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                            </div>
                                        </div>
                                        {/* Blog Post */}                                        
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                <ul className="entry-meta meta-item">
                                                    <li>
                                                        <div className="post-author">
                                                            <Link to="/stylist-profile"><img src={StylistThumb6} alt="Post Author" /> <span>Vix Schneider</span></Link>
                                                        </div>
                                                    </li>
                                                    <li><FontAwesomeIcon icon={faClock} /> 30 Nov 2020</li>
                                                </ul>
                                                <h3 className="blog-title"><Link to="/blog-details">Spring Trend: Pastel Nails</Link></h3>
                                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                            </div>
                                        </div>
                                        {/* Blog Post */}
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                <ul className="entry-meta meta-item">
                                                    <li>
                                                        <div className="post-author">
                                                            <Link to="/stylist-profile"><img src={StylistThumb7} alt="Post Author" /> <span>Jonalyn Graff</span></Link>
                                                        </div>
                                                    </li>
                                                    <li><FontAwesomeIcon icon={faClock} /> 28 Nov 2020</li>
                                                </ul>
                                                <h3 className="blog-title"><Link to="/blog-details">Nail Art - Everything’s coming up rose gold</Link></h3>
                                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                            </div>
                                        </div>
                                        {/* Blog Post */}                   
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                <ul className="entry-meta meta-item">
                                                    <li>
                                                        <div className="post-author">
                                                            <Link to="/stylist-profile"><img src={StylistThumb8} alt="Post Author" /> <span>Yara Sauls </span></Link>
                                                        </div>
                                                    </li>
                                                    <li><FontAwesomeIcon icon={faClock} /> 25 Nov 2020</li>
                                                </ul>
                                        ...
                                        <div className="blog grid-blog">
                                            ...
                                            <div className="blog-content">
                                                <ul className="entry-meta meta-item">
                                                    <li>
                                                        <div className="post-author">
                                                            <Link to="/stylist-profile"><img src={StylistThumb9} alt="Post Author" /> <span>Jaydee Mack</span></Link>
                                                        </div>
                                                    </li>
                                                    <li><FontAwesomeIcon icon={faClock} /> 24 Nov 2020</li>
                                                </ul>
                                                <h3 className="blog-title"><Link to="/blog-details">What’s the Future of Nail Art?</Link></h3>
                                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                            </div>
